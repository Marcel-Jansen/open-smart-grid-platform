...
public class SetDeviceLifecycleStatusRequestData implements ActionRequest {

    private static final long serialVersionUID = 3636769765482239443L;

    private final DeviceLifecycleStatus deviceLifecycleStatus;

    public SetDeviceLifecycleStatusRequestData(final DeviceLifecycleStatus deviceLifecycleStatus) {
    ...
    public DeviceFunction getDeviceFunction() {
        return DeviceFunction.SET_DEVICE_LIFECYCLE_STATUS;
    }
