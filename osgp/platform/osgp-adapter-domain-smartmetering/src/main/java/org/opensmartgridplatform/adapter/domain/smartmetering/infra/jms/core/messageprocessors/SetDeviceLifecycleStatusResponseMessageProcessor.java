...
import org.opensmartgridplatform.dto.valueobjects.smartmetering.SetDeviceLifecycleStatusResponseDto;
...
@Component
public class SetDeviceLifecycleStatusResponseMessageProcessor extends OsgpCoreResponseMessageProcessor {

    @Autowired
    private ManagementService managementService;

    @Autowired
    protected SetDeviceLifecycleStatusResponseMessageProcessor(
    ...
    protected boolean hasRegularResponseObject(final ResponseMessage responseMessage) {
        return responseMessage.getDataObject() instanceof SetDeviceLifecycleStatusResponseDto;
    }

    @Override
    protected void handleMessage(final DeviceMessageMetadata deviceMessageMetadata,
            final ResponseMessage responseMessage, final OsgpException osgpException) throws FunctionalException {
        this.managementService.handleSetDeviceLifecycleStatusResponse(deviceMessageMetadata,
                responseMessage.getResult(), responseMessage.getOsgpException(),
                (SetDeviceLifecycleStatusResponseDto) responseMessage.getDataObject());
    }
